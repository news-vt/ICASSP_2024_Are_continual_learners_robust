...
def add_experiment_args(parser: ArgumentParser) -> None:
    ...
    parser.add_argument('--n_steps', type = int, default = 1,
                        help = 'How many times to iterate stream')
    ...
    parser.add_argument('--eqrm', type = float, default = 0.5, help='probable gurantee')

    parser.add_argument('--env_batch', type=int,
                        help='how many batches from the memeory?.')
    
    parser.add_argument('--erm_pretrain_iters', type =int, default = 0,
                        help = 'how many batches using erm update')
    
    parser.add_argument('--balance', type=float, default = 0.5,
                        help = 'balance parameter')
    
    parser.add_argument('--heldout', type = int, default = 0,
                        help = 'dataset to hold out')
...
def add_management_args(parser: ArgumentParser) -> None:
    ...
    parser.add_argument('--wandb_entity', type=str, default='msukim', help='Wandb entity')
